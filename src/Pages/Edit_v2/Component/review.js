        ...
        <div className='px-2 ms-1'>
            <div
                ...
                <div className='d-flex'>
                    ...
                    Please indicate any gaps identified in its use
                </div>
                <div className='col-12 pt-3'>
                    <div className="col-lg-5 col-md-6 col-sm-8 col-xs-12 py-1" style={{ backgroundColor: '#ECF3F9', borderRadius: 3 }}>
                        <>
                            <div className='d-flex justify-content-end'>
                                <div className="font-weight-bold mb-2 col-10 px-0 pt-1" >Resources and Infrastructure</div>
                            </div>{
                                targetOptions.resource.map((v, k) =>
                                    <CheckBox
                                        k={k}
                                        key={k}
                                        lastIndex={targetOptions.resource.length - 1}
                                        name={'resource'}
                                        id={v.resource_id}
                                        label={v.option_name}
                                        active={
                        ...
                        <>
                            <div className='d-flex justify-content-end'>
                                <div className="font-weight-bold my-2 col-10 px-0 pt-1" >Planning and Coordination</div>
                            </div>{
                                targetOptions.planning.map((v, k) =>
                                    <CheckBox
                                        k={k}
                                        key={k}
                                        lastIndex={targetOptions.planning.length - 1}
                                        name={'planning'}
                                        id={v.plannig_id}
                                        label={v.option_name}
                                        active={
                        ...
                        <>
                            <div className='d-flex justify-content-end'>
                                <div className="font-weight-bold my-2 col-10 px-0 pt-1" >User Experience</div>
                            </div>{
                                targetOptions.user.map((v, k) =>
                                    <CheckBox
                                        k={k}
                                        key={k}
                                        lastIndex={targetOptions.user.length - 1}
            ...
            <div
                ...
                <div className='d-flex'>
                    ...
                    Based on answers indicated in above sections, please tag the level of digital use in relation to this SDG Target.
                </div>
                <div className='col-12 pt-3'>
                                    ...
                                    <div className="pb-2" style={{ borderRadius: 12 }}>
                                        ...
                                        >
                                            ...
                                            {updateRecordData[0].policies.length > 0 && (
                                                <TextEditor
                                                    value={updateRecordData[0].policies[0].policy_and_programme}
                                                />
                                            )}
                                        </div>
                                    </div>
...
const CheckBox = (props) => {
    const { k, name, id, label, active, onChange, lastIndex } = props;
    return (
        <div className='' key={k}>
            <label className='d-flex align-items-center mb-0 '>
                <div className='d-flex col-2 px-0 mr-1'>
                    <input
                        className='mx-auto'
                        type="checkbox"
                ...
                <div
                    className='col-10 py-1 bg-white'
                    style={{
                        borderTopRightRadius: k === 0 ? 6 : 0,
                        borderTopLeftRadius: k === 0 ? 6 : 0,
                        borderBottom: lastIndex !== k && '2px solid #ECF3F9',
                        borderBottomLeftRadius: lastIndex === k ? 6 : 0,
                        borderBottomRightRadius: lastIndex === k ? 6 : 0,
                    }}
                >
                    {label}
                </div>
